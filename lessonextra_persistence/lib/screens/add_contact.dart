...
class _AddContactState extends State<AddContact> {
          ...
          children: [
            SizedBox(
              child: Padding(
                ...
                child: TextButton(
  onPressed: () {
    // Primera validación: verifica que el formulario es válido
    if (formGlobalKey.currentState!.validate()) {
      // Segunda validación: verifica que la imagen esté presente
      if (imageFile == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Por favor, registre la imagen del perfil.',
  ...
  void insertContact() async {
    ...
    if (imageFile == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Por favor, registre la imagen del perfil.')),
      );
      return;
    }
